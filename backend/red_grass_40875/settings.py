"""
Django settings for red_grass_40875 project.
...
ROOT_URLCONF = 'red_grass_40875.urls'
...
WSGI_APPLICATION = 'red_grass_40875.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_grass_40875 API",
    "DESCRIPTION": "API documentation for red_grass_40875 App",
    "VERSION": "v1",
}
